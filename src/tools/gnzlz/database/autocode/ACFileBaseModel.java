...
//	}
	...
	private static String statics(ACTable table) {
		return new StringBuilder()
				...
				.append(tab(2)).append("return ").append(ACFileModel.nameF(table)).append(".find(").append(ACFileModel.nameF(table)).append(".class,primaryKey);").append(line(1))
				.append(tab(1)).append("}").append(line(2))
				.append(tab(1)).append("public static ").append(ACFileModel.nameF(table)).append(" find(String column, Object value) {").append(line(1))
				.append(tab(2)).append("return ").append(ACFileModel.nameF(table)).append(".find(").append(ACFileModel.nameF(table)).append(".class,column,value);").append(line(1))
				.append(tab(1)).append("}").append(line(2))
				...
				.append(tab(2)).append("return ").append(ACFileModel.nameF(table)).append(".findIn(").append(ACFileModel.nameF(table)).append(".class,primaryKeys);").append(line(1))
				.append(tab(1)).append("}").append(line(2))
				...
				.append(tab(2)).append("return ").append(ACFileModel.nameF(table)).append(".findIn(").append(ACFileModel.nameF(table)).append(".class,column,values);").append(line(1))
				.append(tab(1)).append("}").append(line(2))
				...
				.append(tab(2)).append("return ").append(ACFileModel.nameF(table)).append(".findAll(").append(ACFileModel.nameF(table)).append(".class,column,value);").append(line(1))
				.append(tab(1)).append("}").append(line(2))
				...
				.append(tab(2)).append("return ").append(ACFileModel.nameF(table)).append(".all(").append(ACFileModel.nameF(table)).append(".class);").append(line(1))
				.append(tab(1)).append("}").append(line(2))
				...
				.append(tab(2)).append("return ").append(ACFileModel.nameF(table)).append(".select(").append(ACFileModel.nameF(table)).append(".class);").append(line(1))
				.append(tab(1)).append("}").toString();
	}
